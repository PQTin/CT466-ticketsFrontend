<template>
  <div class="comments-wrapper card bg-dark text-white p-4 rounded-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h5 class="fw-bold mb-0">Đánh giá tổng</h5>
      <div class="text-warning">
        <span class="star filled">★</span>
        <strong>{{ avgScore.toFixed(1) }}</strong> / 5
        <span class="text-white-50 ms-2">({{ totalRatings }} đánh giá)</span>
      </div>
    </div>
        ...
        <div class="d-flex">
          ...
          <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center gap-3 mt-2">
              ...
              <span
                v-if="comment.phanHoi && comment.phanHoi.length"
                class="text-info"
    ...
    <div v-else class="text-white-50">Chưa có bình luận nào...</div>
  </div>
</template>
